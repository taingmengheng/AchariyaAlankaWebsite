  ...
  return (
    <div className="slide-container">
      ...
      <div className="pt-32 pb-4 px-4">
        <p
        className="font-elegant text-5xl font-semibold text-center mb-12">
          Explore By Category
        </p>
    ...
    >
      ...
      >
        ...
        <div className="flex items-center justify-between">
          <p className="font-elegant text-xl font-semibold mt-2">{title}</p>
          {/* Assuming EastIcon is defined elsewhere */}
